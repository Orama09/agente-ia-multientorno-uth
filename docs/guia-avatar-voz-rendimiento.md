...
Documento de referencia para desarrolladores sobre los cambios recientes del asistente virtual institucional UTH (AI Avatar).
...
| Concepto | Valor |
|----------|--------|
| Archivo en disco | `public/models/avatar/uth_avatar_final_animado.glb` |
| URL pública | `/models/avatar/uth_avatar_final_animado.glb` |
