...
| `src/components/avatar/Avatar3DPanel.tsx` | Avatar Three.js (`public/models/avatar/uth_avatar_final_animado.glb`) |
...
1. Abrir http://localhost:3001 — la página no debe saltar al chatear.
