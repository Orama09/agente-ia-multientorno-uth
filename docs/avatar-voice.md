...
|------|------------------------|
| Visual | GLB Three.js (`threejs`) en `public/models/avatar/uth_avatar_final_animado.glb`, con animaciones nombradas por estado |
...
| Ubicación | Ruta |
|-----------|------|
| Disco | `public/models/avatar/uth_avatar_final_animado.glb` |
