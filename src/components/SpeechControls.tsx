...
export default function SpeechControls({
  ...
  return (
    ...
    >
      <span className="text-[10px] sm:text-xs font-medium text-[#8C6F23] shrink-0">
        Voz
      </span>
      ...
      <select
        ...
        className="min-w-0 flex-1 max-w-full sm:max-w-[14rem] truncate text-xs border border-emerald-200 rounded-lg px-2 py-1.5 bg-white text-gray-700 outline-none focus:ring-2 focus:ring-[#C5A853]"
      ...
      <select
        ...
        className="shrink-0 text-xs border border-[#C5A853]/40 rounded-lg px-2 py-1.5 bg-white text-gray-700 outline-none focus:ring-2 focus:ring-[#C5A853]"
        value={String(rate)}
