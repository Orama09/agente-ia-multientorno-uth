  ...
  return (
    ...
    <div className="relative w-full h-[340px] sm:h-[300px] flex items-center justify-center overflow-hidden bg-transparent">
      ...
      {/* 3. Header: título/subtítulo a la izquierda, logo a la derecha.
          Antes eran dos <div absolute> independientes que no sabían cuánto
          espacio ocupaba el otro — con el logo de UTH en h-30/h-28 (¡120px/
          112px!) esto se encimaba fuerte con el título en pantallas chicas.
          Ahora es un solo flex row con justify-between: cada lado cede
          espacio al otro y el logo tiene un tope de alto/ancho para que
          nunca invada el lado del título. */}
      <div className="absolute top-2 inset-x-2 flex items-start justify-between gap-2 z-20">

        {/* LADO IZQUIERDO: Título + Subtítulo */}
        <div className="min-w-0 flex flex-col items-start pt-1">
        ...
        {/* LADO DERECHO: Logo UTH */}
        <div className="shrink-0 flex items-start justify-end max-w-[42%] sm:max-w-[190px]">
          <img
            src="/images/logo_uth.png"
            alt="Logo UTH"
            className="h-auto max-h-28 sm:max-h-32 w-auto max-w-full object-contain -mt-6 sm:-mt-7"
          />
        </div>
