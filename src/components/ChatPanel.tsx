...
const markdownListComponents = {
  ul: (props: ComponentPropsWithoutRef<"ul">) => (
    <ul className="list-disc pl-5 space-y-0.5 marker:text-[#C5A853]" {...props} />
  ),
  ol: (props: ComponentPropsWithoutRef<"ol">) => (
    <ol className="list-decimal pl-5 space-y-0.5 marker:text-[#8C6F23] marker:font-semibold" {...props} />
  ),
...
function WelcomeTips() {
  return (
    <div className="rounded-2xl bg-gradient-to-br from-[#F4ECDC] to-[#EADBAB] border border-[#C5A853]/40 p-4 text-sm text-gray-700 space-y-2.5">
      <p className="font-semibold text-[#8C6F23] flex items-center gap-1.5">
        ...
        {messages.map((msg, i) => {
          if (msg.role === "user") {
            return (
              <div
                key={i}
                className="p-3 rounded-2xl max-w-[80%] text-sm bg-[#C5A853] text-white ml-auto"
              >
      ...
      <div className="shrink-0 z-10 bg-white/90 backdrop-blur-md border-t p-3">
        ...
        <div className="flex items-center gap-2">
            ...
            <button
              ...
              className={`p-2 rounded-lg transition-colors shrink-0 ${
                !speechSupported
                  ...
                  : speechEnabled
                    ? "bg-[#C5A853]/40 text-[#8C6F23] hover:bg-[#C5A853]/35"
          ...
          <button
            ...
            onClick={sendMessage}
            disabled={loading}
            className="bg-[#C5A853] text-white px-3 py-2 rounded-xl hover:bg-[#8C6F23] disabled:opacity-50 shrink-0"
