...
export const GREETING_REPLY =
  "¡Hola! Soy el asistente virtual de la UTH. ¿En qué te puedo ayudar? Puedo orientarte sobre la institución, oferta académica, estudiantes, trámites y los requisitos de admisión 2026.";

export const FALLBACK_REPLY =
  "No encontré ese tipo de información. Te sugiero preguntar información relacionada a la institución (Oferta Académica, Estudiantes, Servicios Escolares) o los requisitos de admisión 2026.";
